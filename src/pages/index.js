	...
	return (
		<>
			...
			<main>
				...
				<Project name="Socket Jockey" image={socket} alt="socket jockey">
				...
				<Project name="Shame B0t" image={shamebot} alt="shame bot">
				...
				<Project name="Taurus Trading" image={taurus} alt="taurus trading">
				...
				<Project name="Nutrizone" image={nutrizone} alt="nutrizone">
