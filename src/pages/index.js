	...
	return (
		<>
			...
			<div className="wrapper">
				<h1 style={{fontSize: "8rem"}}>Patrick Hrabos</h1>
				<h2 style={{fontSize: "4rem"}}>Software engineer passionate about the process of coding, from planning to deployment and learning along the way.</h2>
