	...
	return (
		<section className="bio-wrapper">
			<p>
				...
				accountant. I gained valuable business experience and teamwork skills by
				solving the daily challenges of growth that start-up companies often
				face. I have a well-rounded approach to timely solving big problems by
				breaking them down into small, manageable pieces and being diligent
