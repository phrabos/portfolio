		...
		<>
			...
			<section className="project-list">
				...
				>
					...
					preferred diet type. Built remotely with a team of four people over a
					four-day sprint using vanilla JavaScript. I coded the modals, the food
					log page and the feature to add a custom food to the data saved in
					local storage.
				</Project>
				<Project
					name="Taurus Trading"
